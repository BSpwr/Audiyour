...
audio_element_handle_t mixer_init(mixer_cfg_t* config) {
    ...
    mixer_set_settings(audio_element, config->profile.settings);
...
inline esp_err_t mixer_set_settings(audio_element_handle_t self, mixer_settings settings) {
    mixer_t *mixer = (mixer_t *)audio_element_getdata(self);
...
inline esp_err_t mixer_set_gain(audio_element_handle_t self, unsigned source_idx, float gain_db) {
    mixer_t *mixer = (mixer_t *)audio_element_getdata(self);
